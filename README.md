<h1>Math Magicians Calculator Project</h1>
...
# 📖 Calculator Project<a name="about-project"></a>

A simple calculator project with different sections using React.
...
```sh
  git clone https://github.com/Luiscarlosvd/math-magicians-calculator.git
```
